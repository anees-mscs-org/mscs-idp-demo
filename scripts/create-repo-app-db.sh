...
chmod +x dtm
curl -H "Cache-Control: no-cache, no-store" -o config.yaml https://raw.githubusercontent.com/anees-mscs-org/template-go-backend-db-aws/main/config.yaml
